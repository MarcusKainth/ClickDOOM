...
mode against the reference emulator on each new main commit, and files an issue
naming the commit whose first refusal or first divergence moved earlier, or
whose tic statement got slower than its parent's.
