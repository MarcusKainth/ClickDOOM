...
Three frames are covered. Frame 40 is the first frame of demo3 after the screen
...
| File | What it is |
|---|---|
| `demo3-states.tsv` | Three rows in the shape `refemu/probe/README.md` describes: frame index, gametic, frame hash, then every field of `clickdoom_spec::native_state`. |
...
`01539e688afb3350` for frame 1000. The test checks all six before it uses
